...
public class CameraTest extends SimpleRobot {
    ...
    public void robotInit() {
        ...
        cc.addCriteria(MeasurementType.IMAQ_MT_BOUNDING_RECT_WIDTH, 30, 200, false);
        cc.addCriteria(MeasurementType.IMAQ_MT_BOUNDING_RECT_HEIGHT, 15, 100, false);
    }
    ...
    public void autonomous() {
        while (isAutonomous() && isEnabled()) {
            try {
                ...
                BinaryImage thresholdImage = image.thresholdRGB(62, 98, 65, 100, 74, 146);   // keep only red objects
