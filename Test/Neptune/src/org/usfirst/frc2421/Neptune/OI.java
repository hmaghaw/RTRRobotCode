...
public class OI {
    ...
    public JoystickButton shootActivate;
    public JoystickButton shootDeactivate;
    public JoystickButton shooterAngleIncrease;
    public JoystickButton shooterAngleDecrease;
